...
<body>
    ...
    <div>
        ...
        <h1><center><b> VICE CHAIRMAN BALLOT </b></center></h1>
        ...
        <input readonly="true" name="dt" id="dt" type="date" value ="<?php echo date('Y-m-d') ?>" min="2021-07-07" />
               ...
               <input type="radio"  id="vchairman" name="vchairman"  required style="width:98%" size="4"  position:relative  value="<?php echo $row1[3];?>"/><img src="<?php echo $row1[4];?>" width="40" height="40"> <?php echo $row1[3];?> 
            <?php endwhile;?>
                    <br><br><br>
