...
$list2 = "";
$num = 0;
$sql = "SELECT Vchairman, count(Vchairman) AS amount FROM votes GROUP BY Vchairman ORDER BY amount DESC LIMIT 5";
...
<body>
	...
	<section>
		<h1>Vice chairman preliminary results</h1>
		<table>
			<tr>
                <th>candidates</th>
