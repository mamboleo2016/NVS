...
$list2 = "";
$num = 0;
$sql = "SELECT SecGeneral, count(SecGeneral) AS amount FROM votes GROUP BY SecGeneral ORDER BY amount DESC LIMIT 12";
...
<body>
	<section>
		<h1>Secretary general preliminary results</h1>
		<table>
			<tr>
                <th> candidates</th>
