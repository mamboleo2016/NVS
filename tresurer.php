...
$list2 = "";
$num = 0;
$sql = "SELECT tresurer, count(tresurer) AS amount FROM votes GROUP BY tresurer ORDER BY amount DESC ";
...
<body>
	...
	<section>
		<h1>tresurer preliminary results</h1>
		<table>
			<tr>
                <th>candidates</th>
